...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3077677565ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"fr",server:"1",table:"",db:"",token:"32582145223f38597a5e7921674b3a55",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Parcourir",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"config",user:"florian"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=compteuruno&table=partie">`compteuruno`.`partie`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=compteuruno&table=jeu">`compteuruno`.`jeu`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=compteuruno&table=users">`compteuruno`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=compteuruno&table=USERS">`compteuruno`.`USERS`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="32582145223f38597a5e7921674b3a55">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="compteuruno" targettable="users">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `compteuruno`.`users` ( `ID_USER` INT NOT NULL AUTO_INCREMENT ,  `PSEUDO` VARCHAR(200) NOT NULL ,  `MDP` VARCHAR(200) NOT NULL ,  `DROIT` INT(3) NOT NULL ,    PRIMARY KEY  (`ID_USER`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="compteuruno" targettable="users">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `users` (`ID_USER`, `PSEUDO`, `MDP`, `DROIT`) VALUES (NULL, &#039;ADMIN&#039;, &#039;835d6dc88b708bc646d6db82c853ef4182fabbd4a8de59c213f2b5ab3ae7d9be&#039;, &#039;0&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="compteuruno" targettable="partie">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `compteuruno`.`partie` ( `ID_PARTIE` INT NOT NULL AUTO_INCREMENT ,  `JEU` INT NOT NULL ,  `ETAT` INT NOT NULL ,  `SCORE_JOUEUR_1` INT NOT NULL ,  `SCORE_JOUEUR_2` INT NOT NULL ,  `SCORE_JOUEUR_3` INT NOT NULL ,  `SCORE_JOUEUR_4` INT NOT NULL ,  `SCORE_JOUEUR_5` INT NOT NULL ,  `SCORE_JOUEUR_6` INT NOT NULL ,  `SCORE_JOUEUR_7` INT NOT NULL ,  `SCORE_JOUEUR_8` INT NOT NULL ,  `SCORE_JOUEUR_9` INT NOT NULL ,  `SCORE_JOUEUR_10` INT NOT NULL ,  `JOUEUR_GG` INT NOT NULL ,    PRIMARY KEY  (`ID_PARTIE`)) ENGINE = InnoDB;</span>
                        </div>
